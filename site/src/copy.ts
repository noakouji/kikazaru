...
export const ja: Copy = {
  ...
  page: {
    ...
    freeBody: [
      ...
      'それに、対応スピーカーを増やすには持っている人に試してもらうしかありません。売るより配るほうが早い。',
    ],
    ...
    nothingBody: '支援した人だけ機能が増える、みたいなことはしません。全員が同じものを使えるほうがいいので。名前を出すこともしません。Ko-fi のメッセージ欄に何か書いてもらえれば、返信はします。',
    payHeading: 'コーヒーをおごる',
