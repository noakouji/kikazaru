...
export const ja: Copy = {
  ...
  hero: {
    ...
    sub: '音声入力やオンライン会議のあいだ、Sonos や Google Home を自動で静かにします。話し終わると、元の音量にそのまま戻ります。',
    download: 'Kikazaru をダウンロード',
    meta: 'macOS 14 以降 / 無料 / 約 400 KB',
    note: ['ダウンロードしたあと、', '初回だけひと手間かかります', '。1分で終わるので、先に読んでおくと安心です。'],
  },
  shot: {
    heading: '設定はこれだけ',
  ...
  problem: {
    ...
    want: '作業中はスピーカーで音楽をかけておきたい。でも音声入力もオンライン会議も使う。この2つを両立させようとすると、いまは毎回どちらかを我慢することになります。',
    before: 'いままで',
    ...
    causeTail: [
      ...
      'そこだけを埋めるのが Kikazaru です。',
    ],
  },
  steps: {
    label: '動き',
    heading: '入れておくだけで、あとは勝手に',
    items: [
  ...
  why: {
    label: 'なぜ作ったか',
    heading: 'これから、喋って書く時間はもっと増える',
    body: [
      'AI に指示を出すのも、議事録をまとめるのも、キーボードより口のほうが速い場面が増えました。音声入力を一日中使うようになると、それまで気にならなかった「スピーカーの音がマイクに入る」が、毎回の小さなストレスとして効いてきます。',
      'そのたびに音楽を止めたり、ヘッドホンに付け替えたりするのが面倒で作りました。',
      'Kikazaru を入れておけば、音楽は流したままで構いません。',
    ],
  },
  install: {
    label: 'インストール',
    ...
    calloutSub: '個人が趣味で配っているアプリなので、この形になっています。ここだけ、お手数をおかけします。',
    steps: [
